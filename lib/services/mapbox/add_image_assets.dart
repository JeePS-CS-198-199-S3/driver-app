...
Future<void> addImagesFromAsset(MapboxMapController mapController) async {
  ...
  final ByteData accidentBytes = await rootBundle.load("lib/images/accident.png");
  final Uint8List accidentList = accidentBytes.buffer.asUint8List();

  final ByteData crimeBytes = await rootBundle.load("lib/images/crime.png");
  final Uint8List crimeList = crimeBytes.buffer.asUint8List();

  final ByteData mechErrorBytes = await rootBundle.load("lib/images/mechError.png");
