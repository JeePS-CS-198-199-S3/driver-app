...
//     List<LatLng> routeCoordinates = route!.route_coordinates
...
//       lineColor: '#${route!.route_color.toRadixString(16).toString().substring(2)}',
//       lineWidth: 3.0,
//     ));
//   }
//
...
//
//     if (driver != null) {
//       jeep = await getJeepById(driver!.jeep_driving);
//     }
//
//     if (jeep != null) {
//       route = await getRouteById(jeep!.route_id);
//     }
//
//     setState(() {});
//
